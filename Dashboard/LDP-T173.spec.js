...
test('Verify the close icon displayed in Location hierarchy search bar in KPI Impact grid',async ({browser})=>
{
    let webContext;
    ...
    await page.frameLocator('#mfe').locator(inputdata.SearchTab).type("vsvsvsv", {delay:100});
