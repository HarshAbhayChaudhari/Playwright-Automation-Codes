...
{   
    ...
    var bool = await frame.locator("input[type='text'] >> nth=0").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("input[type='text'] >> nth=1").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("button >> nth=2").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("button >> nth=3").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("button >> nth=4").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("[aria-label='Aggregate Until Date']").isVisible();
    expect(bool).toBeTruthy();
    //await page.pause();
