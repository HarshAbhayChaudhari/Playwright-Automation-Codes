...
test(' Verify the metrics in KPI Impact grid',async ({browser})=>
{   
    ...
    expect(bool).toBeTruthy();
    var bool = await page.frameLocator('#mfe').locator(inputdata.Revenue).isVisible();
    expect(bool).toBeTruthy();
    var bool = await page.frameLocator('#mfe').locator(inputdata.Profit).isVisible();
    expect(bool).toBeTruthy();
    //await page.pause();
});