...
{   
    ...
    await frame.locator("div:nth-child(6) > .MuiGrid-root > .MuiFormControlLabel-root > .MuiButtonBase-root > .MuiIconButton-label > [type='radio']").click();
    ...
    var bool = await frame.locator("input[value='PHI VILLA 5 PCS PATIO DINING SET']").isVisible();
