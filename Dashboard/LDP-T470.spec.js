...
{   
    ...
    var bool = await frame.locator("[data-testid='search-field']").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("text=Show All").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("text=Show Selected Only").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("text=Clear Selection").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("button:has-text('Done')").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("[aria-label='close'] >> nth=0").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("[data-testid='hierarchy-selector'] [aria-label='close']").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("[data-testid='expand-icon'] >> nth=1").isVisible();
    expect(bool).toBeTruthy();
