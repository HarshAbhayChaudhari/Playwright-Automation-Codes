...
test('Verify the metrics in Cumulative KPI Impact grid',async ({browser})=>
{   
    let webContext;
    ...
    var bool = await frame.locator("text=Stocks (PCS)").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("text=Cumulative Revenue").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("text=Markdown Budget").isVisible();
    expect(bool).toBeTruthy();
    var bool = await frame.locator("text=Relative Price ($)").isVisible();
    expect(bool).toBeTruthy();
    //await page.pause();
