...
test( 'Verify the default fields in Product Attributes on Filters grid',async({browser})=>
{
    ...
    var bool = frame.locator(inputdata.ProductAttributes).isVisible();
    expect(bool).toBeTruthy();
    await expect(frame.locator(inputdata.ProductAttributes)).toHaveText("Product Attributes");
    await page.waitForTimeout(3000);
})