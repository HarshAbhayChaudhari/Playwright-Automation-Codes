...
test('KPI Save Settings',async ({browser})=>
{
    let webContext1;
    ...
    await page.frameLocator('#mfe').locator(inputdata.ClearAll).click(); //clear all KPIs
    ...
    //await page.frameLocator('#mfe').locator("text='Add All'").click();
