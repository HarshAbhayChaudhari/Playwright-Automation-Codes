...
test('Additional filters drop down',async ({browser})=>
{
    let webContext1;
    ...
    await page.frameLocator('#mfe').locator("[data-testid='lui-ccl-card-header-iconbutton'] >> span[class='MuiIconButton-label'] >> svg[focusable='false'] >> nth=2").click();
    await page.frameLocator('#mfe').locator("text=Strategy​ >> div[role='button']").click();
    //await page.pause();
})