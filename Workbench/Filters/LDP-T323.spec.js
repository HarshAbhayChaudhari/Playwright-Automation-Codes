...
test('Reset action in filters grid',async ({browser})=>
{
    let webContext1;
    ...
    await page.frameLocator('#mfe').locator("button:has-text('Reset')").click();
    var bool = await page.frameLocator('#mfe').locator("text=Denver >> nth=0").isVisible();
