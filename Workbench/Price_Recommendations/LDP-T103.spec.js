...
test('PR Add All Action',async ({browser})=>
{
    let webContext1;
    ...
    //await page.pause();
    await page.frameLocator('#mfe').locator(inputdata.SettingsP).click(); //click on setting icon of Price recommandation
    ...
    await page.frameLocator('#mfe').locator(inputdata.AddAll).click();
