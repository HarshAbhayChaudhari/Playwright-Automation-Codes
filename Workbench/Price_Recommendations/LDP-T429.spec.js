...
test('Verify the Price Recommendations grid display when TPRs columns is not included',async ({browser})=>
{
    let webContext1;
    ...
    await page.frameLocator('#mfe').locator("div:nth-child(13) > .card-item > .MuiButtonBase-root").click();
    var bool = await page.frameLocator('#mfe').locator("text=Available Columns (1)").isVisible();
