...
test('Verify the Overriden column behavior in flat view',async ({browser})=>
{
    let webContext1;
    ...
    await expect(frame.locator("text=Override LAWNSCAPE PROPATCH LAWN REPAIR 3.5LB")).toHaveText("Override LAWNSCAPE PROPATCH LAWN REPAIR 3.5LB");
