...
test('Verify if the check box is selected when user clicks on overriden cell in flat view',async ({browser})=>
{
    let webContext1;
    ...
    //await page.pause();
    await page.waitForTimeout(3000);
    let gittt = frame.locator("text=SCOTTS TURF BUILDER KENTUCKY BLUEGRASS >> nth=0");
